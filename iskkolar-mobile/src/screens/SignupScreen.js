...
const CITIZENSHIP_OPTIONS = ["Filipino", "Canadian", "Others"];
const STEP_TITLES = [
  "Account Setup",
  "Personal Details",
  "Contact & Background",
...
export default function SignupScreen({ navigation }) {
  ...
  const setProfilePhoto = () => {
    setForm((prev) => ({
      ...prev,
      profilePhoto: prev.profilePhoto ? null : require("../../assets/images/logo.png"),
    }));
  };
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              showPicker("Select citizenship", CITIZENSHIP_OPTIONS, form.citizenship, (value) =>
                setForm({ ...form, citizenship: value })
              )
            }
          >
            <Text style={[styles.input, { paddingVertical: 14 }]}>
    ...
    <>
      ...
      <View style={styles.reviewCard}>
        ...
        <View style={styles.reviewSection}>
          ...
          <Text style={styles.reviewTextSmall}>Citizenship: {form.citizenship || "-"}</Text>
        </View>
